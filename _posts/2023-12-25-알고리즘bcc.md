...
![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled.png)
...
![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 1.png)
...
![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 2.png)

![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 3.png)

- Spanning Tree 형태로 dfn을 구하면 다음과 같다.

![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 4.png)
...
- 아래 그래프와 트리에서 `Back Edges` 부분은 다음과 같다.
   ...
   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 5.png)

   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 6.png)
...
- depth-first spanning tree에서 분절점을 찾는 방법은 두 가지가 있다.
   ...
   1. 두 개 이상의 child vertex를 가진다면 분절점이다.
      ...
      - 즉, 위 tree에서 root node는 분절점이다.
         ...
         ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 7.png)
...
- $low(u)$
   ...
   - vertex $u$가 자신이 가장 낮은 dfn수로 가기 위한 방법은 3가지 중 가장 작은 값을 구하면 된다.
      ...
      1. $dfn(u)$
         ...
         ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 8.png)

      2. $min\{{low(w) | w\text{ }is\text{ }a\text{ }child\text{ }of\text{ }u\}}$

         1.  $u$의 child vertex인 $w$들의 $low$ 값 중 가장 작은 값이다.

      ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 9.png)

      1. $min\{{dfn(v)|(u,v)\text{ }is\text{ }a\text{ }back\text{ }edge\}}$
         1. $u$의 ancestor인 $v$로 이어지는 back edge 중 가장 작은 값이다.

   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 10.png)
...
![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 11.png)

![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 12.png)
...
- $1$ vertex는 Articulation point이다.
   ...
   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 13.png)

<br>

- $2$ vertex는 Articulation point가 아니다.

   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 14.png)

<br>

- $4$ vertex는 Articulation point가 아니다.

   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 15.png)

<br>

- $7$ vertex는 Articulation point이다.

   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 16.png)

   <br>

- $6$ vertex는 Articulation point가 아니다.

   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 17.png)

   <br>

- $5$ vertex는 Articulation point이다.

   ![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 18.png)
...
![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 19.png)
...
![Untitled]({{site.url}}/images/2023-12-25-알고리즘bcc/Untitled 20.png)
