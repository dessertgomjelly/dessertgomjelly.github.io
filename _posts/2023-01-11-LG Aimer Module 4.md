...
<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112160700057.png" alt="image-20240112160700057" style="zoom: 67%;" />
...
<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112161849777.png" alt="image-20240112161849777" style="zoom:50%;" />

<br>

### Local optimum VS global optimum

<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112162455585.png" alt="image-20240112162455585" style="zoom: 67%;" />
...
<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112163321268.png" alt="image-20240112163321268" style="zoom:50%;" />
...
<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112182424101.png" alt="image-20240112182424101" style="zoom:67%;" />
...
-  비록 Local optimum(지역 최적해) 에는 취약하지만, 어느정도 수렴해 가는 것을 알 수 있다.
   ...
   ![image-20240112182923703](/Users/dessert_gomjelly/Desktop/깃허브블로그/dessertgomjelly.github.io/images/2023-01-11-LG Aimer Module 4/image-20240112182923703.png)
...
<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112201421974.png" alt="image-20240112201421974" style="zoom:67%;" />
...
<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112202550261.png" alt="image-20240112202550261" style="zoom:50%;" />
...
<{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112203208007.png" alt="image-20240112203208007" style="zoom:67%;" />
...
-  이 알고리즘의 순서는 다음과 같다.
   ...
   -  3.  그다음은 통계적으로 안정된 값을 위해 bias를 Correct 한다.
          ...
          <{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112204429141.png" alt="image-20240112204429141" style="zoom:50%;" />

   -  4.  마지막으로 파라미터를 업데이트 한다.

          <{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112204457656.png" alt="image-20240112204457656" style="zoom:50%;" />
...
-  수식을 살펴보면 MSE 부분을 fitting이라고 한다면 그 뒤의 수식은 세타 j값이 크면 클수록 늘어나게 되는 오류이다.
   ...
   -  모델의 입장에서는 가능한한 세타를 쓰지 않으면서 이 Loss 를 최소화하는 노력을 한다.
      ...
      <{{site.url}}/images/2023-01-11-LG Aimer Module 4/image-20240112205757906.png" alt="image-20240112205757906" style="zoom:50%;" />
