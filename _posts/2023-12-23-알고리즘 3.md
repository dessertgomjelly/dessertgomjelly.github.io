...
- <img src="{{site.url}}/images/2022-12-21-알고리즘 1/Un1.png" style="zoom:50%;" />이해하기 편하게 트리구조를 그려 재귀 동작 방식을 나타낼 수 있다.
- 각 `Champion(0,1)`메서드의 실행 순서를 번호로 나타내면 아래처럼 가능하다.

<img src="{{site.url}}/images/2022-12-21-알고리즘 1/Un2.png" style="zoom:50%;" />
